...
public class TsscGame implements Serializable {
	...
	public TsscTimecontrol addTimeControl(TsscTimecontrol time) {
		time.setTsscGame(this);
		getTsscTimecontrols().add(time);
		return time;
	}
